...
//       <a className="text-2xl font-bold text-violet-600 dark:text-white" >
//         CNAPP Dashboard
//       </a>
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="relative px-4 py-2 flex justify-between items-center bg-white dark:bg-gray-800 border-b-2 dark:border-gray-600">
        <a className="text-xl font-bold text-black dark:text-white" href="#">
          CNAPP Dashboard
        </a>
        <div className="lg:hidden">
          <button
        ...
        <div className="hidden lg:flex">
          ...
          <div>
            <button className="py-1.5 px-3 m-1  text-center bg-gray-100 border border-gray-300 rounded-md text-black hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 hidden lg:inline-block">
              <div className="flex flex-row justify-center items-center gap-4">
                <div>
                  <MdAccessTime />
                </div>
                <div className="flex flex-row justify-center items-center border-l p-1 ">
                  <div>Last 2 days</div>
                  <div>
                    <IoIosArrowDown />
                  </div>
      ...
      {isMenuOpen && (
        <div className="navbar-menu relative z-50">
          ...
          <nav className="fixed bg-white dark:bg-gray-600 top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 border-r overflow-y-auto">
            <div className="flex items-center mb-8">
              <div className="mr-auto text-2xl font-bold text-black text-violet-600 dark:text-gray-100">
                Dashboard
              </div>
...
import { GrOptimize } from "react-icons/gr"; */}
            ...
            <div>
              <ul>
                <li className="mb-1">
                  <button className="block p-4 text-sm  w-[120px] pl-12 text-white bg-violet-600 dark:text-gray-300 font-semibold hover:bg-violet-50 hover:text-violet-600 rounded dark:hover:bg-gray-800">
                    <TfiReload className="h-8 w-6" />
                  </button>
                </li>
                <li className="mb-1">
                  <button className="block p-4 text-sm w-[120px] pl-12 text-white bg-violet-600 dark:text-gray-300 font-semibold hover:bg-violet-50 hover:text-violet-600 rounded dark:hover:bg-gray-800">
                    <MdAccessTime className="h-8 w-6" />
                  </button>
                </li>
                <li className="mb-1">
                  <button className="block p-4 text-sm bg-violet-600  text-white dark:text-gray-300 font-semibold hover:bg-violet-50  rounded dark:hover:bg-gray-800">
                    <AddButton />
                  </button>
                </li>
